...
- Support datetime and zoneinfo in Jinja templates
...
- Fixed configuration of WeasyPrint and issues with FontConfig cache
...
- Adjusted to changes in Document Templates and Knowledge Models API (ID to UUID)
...
- Updated to newer Docker base image due to vulnerability (CVE-2025-58050)[https://nvd.nist.gov/vuln/detail/CVE-2025-58050]

## [4.23.1]

### Changed

- Updated to newer Docker base image due to vulnerabilities (CVE-2025-49794)[https://nvd.nist.gov/vuln/detail/CVE-2025-49794] and (CVE-2025-49796)[https://nvd.nist.gov/vuln/detail/CVE-2025-49796]

## [4.23.0]

### Changed

- Strip trailing `/` from client URL in document context
...
- Fixed missing raw value from integration reply when using ``extract_replies`` filter
