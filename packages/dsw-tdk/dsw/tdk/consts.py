...
METAMODEL_VERSION_MAJOR = DOCUMENT_TEMPLATE_METAMODEL_VERSION.major
METAMODEL_VERSION_MINOR = DOCUMENT_TEMPLATE_METAMODEL_VERSION.minor
METAMODEL_VERSION = str(DOCUMENT_TEMPLATE_METAMODEL_VERSION)
