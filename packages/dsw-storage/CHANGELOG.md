...
- Methods for downloading and storing document template locales and for storing the document template POT file
...
- Adjusted to changes in Document Templates (ID to UUID)
