...
from dsw.templating.locales import RenderContext
...
@pytest.fixture
def step(make_template, template_dir: pathlib.Path) -> Jinja2Step:
    return Jinja2Step(make_template(template_dir), {'template': ROOT_FILE})
...
def test_legacy_i18n_options_are_ignored(make_template, template_dir):
    step = Jinja2Step(make_template(template_dir), {
        'template': ROOT_FILE,
        'jinja-ext': 'i18n',
        'i18n-dir': 'locale',
        'i18n-lang': 'cs',
