...
class RequestsWrapper:
    ...
    def __init__(self, settings: RequestsSettings, policy: UrlPolicy):
        # private: the Jinja sandbox must not hand the raw module to templates
        self._requests = require('requests', 'http')
